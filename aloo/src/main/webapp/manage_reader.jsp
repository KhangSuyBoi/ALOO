            ...
            <div class="container">
                <div class="row justify-content-around">
                    <form action="" class="bg-black text-light col-md-10 bg-light p-3 my-3">
                    	<div class="row">
                    		<div class="col-md-5">
		                    	<h1 class=" tex-uppercase h3 py-2">Danh sách người mượn</h1>
		                    </div>
                            ...
                            <table class="table table-dark">
                              ...
                              <tbody>
                                <tr>
                                  ...
                                  <td>
                                  	<div class="d-grid gap-2">
			                            <input type="button" value="Còn hạn" class=" btn btn-success mt-1">
			                        </div>
                                  </td>
                                  <td>
                                    	<div class="d-grid gap-2">
                                ...
                                <tr>
                                    ...
                                    <td>
                                    	<div class="d-grid gap-2">
			                            	<input type="button" value="Đến hạn" class=" btn btn-warning mt-1" onclick="location.href='edit_book.jsp'">
			                        	</div>
                                    </td>
                                    <td>
                                    	<div class="d-grid gap-2">
                                ...
                                <tr>
                                    ...
                                    <td>
                                    	<div class="d-grid gap-2">
			                            	<input type="button" value="Quá hạn" class=" btn btn-danger mt-1" onclick="location.href='edit_book.jsp'">
			                        	</div>
			                        </td>
                                   	<td>
                                    	<div class="d-grid gap-2">
