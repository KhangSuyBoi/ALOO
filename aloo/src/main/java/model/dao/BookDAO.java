...
public class BookDAO {
	...
	public Book findBook(String idBook)throws SQLException, ClassNotFoundException {
		...
		while(rs.next()) {
			...
			String idAuthors = rs.getString("idAuthors");
			String idBookShelf = rs.getString("idBookShelf");
	...
	public int deleteBookAuthors(String idAuthors) throws SQLException, ClassNotFoundException{
		int result = 0;
		if(conn == null)
			conn = ConnectDatabase.getMySQLConnection();
