...
public class BookShelfBO {
	...
	public BookShelf findBookShelf(String idBookShelf) throws ClassNotFoundException, SQLException {
	...
	public ArrayList<BookShelf> list() throws ClassNotFoundException, SQLException {
		return bookShelfDAO.getAllBookShelf();
	}
	public boolean deleteBookShelf(String idBookShelf) throws ClassNotFoundException, SQLException {
